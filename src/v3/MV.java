...
public final class MV {
	...
	static final int maxSimRounds = 1000000, MAX_NEW_FUNC_LEN = 10000, MAX_SUB_MODULES = 5, MAX_NEW_FUNC_DEPTH = 5,
			TSIZE = 2, POPSIZE_PER_CASE_LEVEL_DEME = 10, SAMPLE_SIZE = 1000,
			...
			EVO_ROUNDS_PER_CASE = 1000, REPLACE_TRIALS = 10, TIMEFRAME_IN_MINUTES = 1, NUM_INPUT_UNITS = 15, FORWARD_OUTPUT = 5;
	...
	static int numOfInputs, numOfConstants,  primitiveInputsLength, currentDeme, currentLevel,
			currentRound;
	...
	static double currentOutput, currentWin, SPREAD = 0.00025;
